...
[Link to Albert Terrazas's Portfolio](https://sage-pastelito-ff5669.netlify.app/)
...
- Users can also feel free to access the live application directly by visiting the Netlify link (https://sage-pastelito-ff5669.netlify.app/).

## Credits

Credits are attributed to Juno Nuygen for his awesome help as a tutor. 
...
This application is very user intuitive, just visit the site (https://sage-pastelito-ff5669.netlify.app/), navigate through different pages using the links in the nav-bar, and view desired content.
